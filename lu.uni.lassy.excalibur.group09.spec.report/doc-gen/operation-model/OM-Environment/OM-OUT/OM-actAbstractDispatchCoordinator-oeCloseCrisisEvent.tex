...
The \msrcode{oeCloseCrisisEvent} operation has the following properties:
	...
	\addnumberedsinglerow{PreP}{The dispatch coordinator's mode has been set to \msrcode{isInMainWithCloseEventUnlocked}.}
	...
	\addnumberedsinglerow{PostP}{The dispatch coordinator's mode has been set to \msrcode{isInStandBy}.}
	\end{operationmodel}
