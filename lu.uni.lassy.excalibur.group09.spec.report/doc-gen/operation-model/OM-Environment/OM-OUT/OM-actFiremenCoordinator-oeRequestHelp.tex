...
The \msrcode{oeRequestHelp} operation has the following properties:
	...
	\addnumberedsinglerow{PreP}{The firemen coordinator's mode has is \msrcode{isNull}.}
	\addnumberedsinglerow{PreP}{The firemen coordinator's modeFM is \msrcode{isInRequestHelp}.}
	...
	\addnumberedsinglerow{PostF}{The crisis event (self.rnActor.rnctCrisisEvent) is then associated to the selected dispatch coordinator(s).}
