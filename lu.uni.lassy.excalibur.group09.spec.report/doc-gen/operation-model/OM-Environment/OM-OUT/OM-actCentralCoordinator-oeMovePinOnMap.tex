...
The \msrcode{oeMovePinOnMap} operation has the following properties:
	...
	\addnumbereddoublerow{}{AdtGeoPos: dtGeoPos}{the new geographical position of where the pin should be moved to.} 
	...
	\addnumberedsinglerow{PreF}{It is supposed that the actor's is already associated with a newly created map with pin.}
