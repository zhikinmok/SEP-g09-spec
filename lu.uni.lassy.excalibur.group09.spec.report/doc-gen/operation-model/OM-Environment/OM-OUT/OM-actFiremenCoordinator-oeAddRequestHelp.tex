...
The \msrcode{oeAddRequestHelp} operation has the following properties:
	...
	\addnumberedsinglerow{PreP}{The firemen coordinator's mode has been set to \msrcode{isInMain} or \msrcode{isInMainWithCloseEventUnlocked}.}
	\addnumberedsinglerow{PreP}{The firemen coordinator's modeFM has been set to \msrcode{isNotInRequestHelp}.}
