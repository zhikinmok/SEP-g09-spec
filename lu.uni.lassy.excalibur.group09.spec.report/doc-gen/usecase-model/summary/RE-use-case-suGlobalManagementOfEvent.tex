...
\msrcode{suGlobaManagementOfEvent} is the summary level use-case that covers most of the operation that the system provides.		  
...
\addsinglerow{\msrcode{suGlobaManagementOfEvent} is the summary level use-case that covers most of the operation that the system provides.}
